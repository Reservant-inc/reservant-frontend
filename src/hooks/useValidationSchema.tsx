...
export const useValidationSchemas = () => {
  ...
  const menuSchema = yup.object({
    ...
    menuType: yup.string().required(t('errors.create-menu.menuType.required')),
    dateFrom: yup.string().required(t('errors.create-menu.dateFrom.required')),
    dateUntil: yup
      .string()
      .nullable()
      .test('is-valid-date', t('errors.create-menu.dateUntil.valid'), value => {
