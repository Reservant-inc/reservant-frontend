    ...
    <div className="flex h-fit self-start flex-col w-full bg-white rounded-lg p-4 gap-4 shadow-md">
      ...
      {isLoading ? (
        ...
        <div className="space-y-4">
          ...
          <p><strong>Address:</strong> {restaurant.address}, {restaurant.postalIndex}, {restaurant.city}</p>
          <p><strong>Location:</strong> Lat {restaurant.location.latitude}, Lng {restaurant.location.longitude}</p>
          <p><strong>Delivery:</strong> {restaurant.provideDelivery ? 'Yes' : 'No'}</p>
          <p><strong>Description:</strong> {restaurant.description}</p>
          <p><strong>Max Reservation Duration:</strong> {restaurant.maxReservationDurationMinutes} minutes</p>
          <p><strong>Rating:</strong> {restaurant.rating} / 5 ({restaurant.numberReviews} reviews)</p>
