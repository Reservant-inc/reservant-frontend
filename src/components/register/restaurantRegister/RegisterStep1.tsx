  ...
  return (
    <div>
      <Formik
        ...
        validationSchema={RestaurantRegisterStep1Schema}
        ...
        {(formik) => (
          <Form>
            <div className="form-container">
              ...
              <div className="form-control">
                <label htmlFor="businessPermissionFile">
                  {t("restaurant-register.businessLicense")}:
                </label>
                <input
                  type="file"
                  id="businessPermissionFile"
                  name="businessPermissionFile"
                  accept=".pdf"
                  onChange={(e) =>
                    formik.setFieldValue(
                      "businessPermissionFile",
                      e.target.files && e.target.files[0],
                    )
                  }
                />
