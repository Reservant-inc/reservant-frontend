...
import { fetchDELETE, fetchGET, fetchPOST, getImage } from '../../../services/APIconn'
import { EventDataType, EventDialogState, InterestedUser } from '../../../services/types'
...
const Event: React.FC<EventProps> = ({ event, listType, refreshEvents }) => {
  ...
  const openDialog = (type: 'delete' | 'leave' | 'details' | 'manageParticipants' | 'edit') => {
