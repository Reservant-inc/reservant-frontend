      ...
      <div className=" p-2 ">
        <a
          ...
          className={
            props.className
              ? props.className
              : "menu-item flex flex h-14 items-center rounded-xl p-2 text-black  hover:bg-primary-2 hover:text-white  dark:text-grey-1 dark:hover:bg-secondary dark:hover:text-black"
          }
          onClick={onClicked}
        >
          ...
          >
            <div className="w-full">
              <ThemeProvider theme={theme}>
                ...
                <DropdownItem
                  className="menu-item flex flex h-14 cursor-default items-center rounded-xl p-2 text-black  hover:bg-primary-2 hover:text-white  dark:text-grey-1 dark:hover:bg-secondary dark:hover:text-black"
                  leftIcon={
          ...
          >
            <div className="w-full">
              ...
              <DropdownItem
                ...
                className={
                  i18next.language === "en"
                    ? "menu-item text-gray-1 flex flex h-14 cursor-default  items-center rounded-xl bg-primary-2 p-2 text-white dark:bg-secondary dark:text-black "
                    : ""
                }
              >
                {" "}
