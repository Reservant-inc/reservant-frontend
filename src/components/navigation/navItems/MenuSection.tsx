...
const Section: React.FC<SectionProps> = ({ component, connString }) => {
    ...
    return(
        <div className="relative h-14">
            <button className={'h-12 mt-1 w-28 rounded-xl fill-grey-2 flex flex-col justify-between items-center relative' + (isClicked ? ' fill-primary-2 dark:fill-secondary dark:hover:bg-none hover:bg-transpartent' : " dark:hover:bg-grey-4 hover:bg-grey-1")} onClick={() => navigate(connString)}>
                { component }
            </button>
