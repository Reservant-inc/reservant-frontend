...
const EmployeeManagement: React.FC<EmployeeManagementProps> = (activeRestaurantId) => {
    ...
    const handleSelectAllClick = (event: React.ChangeEvent<HTMLInputElement>) => {
      if (event.target.checked) {
        const newSelected = rows.map((n) => n.colnum);
                    ...
                    <div>
                        ...
                        >
                            ...
                            {visibleRows.map((row, index) => {
                                const isItemSelected = isSelected(row.colnum as number);
                                ...
                                <TableRow 
                                    hover
                                    onClick={(event) =>
                                    handleClick(event, row.colnum as number)
                                    }
                                    role="checkbox"
                                ...
                                >
                                    ...
                                    <TableCell align="left">
                                    <Checkbox checked={row.isHallEmployee as boolean} />
                                    </TableCell>
                                </TableRow>
                                );
                            })}
