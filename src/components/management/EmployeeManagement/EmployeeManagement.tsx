...
export default function EmployeeManagement() {
  ...
  useEffect(() => {
    const populateRows = async () => {
      try {
        ...
        const getRole = (employment: {isBackdoorEmployee: boolean, isHallEmployee: boolean}): string => {
          return employment.isBackdoorEmployee ? employment.isHallEmployee ? 'Hall and Backdoor' : 'Backdoor' : employment.isHallEmployee ? 'Hall' : 'None'
        }
  ...
  return (
    <div className='h-full'>
      ...
      >
        <div className='h-[500px] w-[500px] bg-white rounded-xl p-3'>
