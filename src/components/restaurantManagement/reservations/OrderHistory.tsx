...
import { MenuIteminOrderType, OrderType, UserType } from "../../../services/types";
                    ...
                    <Box display="flex" className="gap-24">
                      <Box flex={1}>
                        ...
                        <Table size="small" aria-label="menu items">
                          ...
                          <TableBody>
                            {row.employees?.map((employees: UserType, index: number) => (
                              <TableRow key={index}>
                      ...
                      <Box flex={1}>
                        ...
                        <Table size="small" aria-label="menu items">
                          ...
                          <TableBody>
                            {row.items?.map((items: MenuIteminOrderType, index: number) => (
                              <TableRow key={index}>
