...
const RestaurantManager = () => {
  ...
  return (
    <div className="flex h-[calc(100%-3.5rem)] w-full bg-grey-1 bg-grey-1 dark:bg-grey-3 dark:text-white">
      <div className="z-[0] flex w-full">
        ...
        <div className="flex h-full w-[84%] flex-col gap-6 p-6">
          ...
          <div id="asdasd" className="h-[calc(90%-1.5rem)] w-full rounded-lg shadow-md">
          {
            {
