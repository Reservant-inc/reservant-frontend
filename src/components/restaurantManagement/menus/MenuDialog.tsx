...
const MenuDialog: React.FC<MenuDialogProps> = ({
  ...
  return (
    <Dialog open={open} onClose={onClose}>
      <DialogTitle>
        {editedMenu
          ? t("restaurant-management.menu.editedMenu")
          : t("restaurant-management.menu.newMenu")}
      </DialogTitle>
      <DialogContent>
        <TextField
          autoFocus
        ...
        >
          <MenuItem value="Food">
            {t("restaurant-management.menu.typeFood")}
          </MenuItem>
          <MenuItem value="Alcohol">
            {t("restaurant-management.menu.typeAlcohol")}
          </MenuItem>
          <MenuItem value="Drink">
            {t("restaurant-management.menu.typeDrink")}
          </MenuItem>
          <MenuItem value="Dessert">
            {t("restaurant-management.menu.typeDessert")}
          </MenuItem>
        </TextField>
        <TextField
          required
